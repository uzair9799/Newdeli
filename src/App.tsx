...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] selection:bg-orange-500/30 selection:text-orange-500 relative">
      {/* Simple, unclosable Rate Limit Exceeded Blocker */}
      <div className="fixed inset-0 z-[9999] bg-[#09090b] flex items-center justify-center p-6 text-center select-none">
        <div className="max-w-md w-full bg-zinc-950 border border-zinc-800 rounded-2xl p-8 shadow-2xl">
          <p className="text-zinc-300 text-sm font-semibold font-sans">
